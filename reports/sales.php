...
$service = new \db\Dao;
	...
	$res=Array();
	$select = "play_product.idx as product_idx, play_product.name as product_name, price, 
			play_product_category.name as category_name, play_product.name as product_name, sale_start, sale_end";
	$table = "play_product";
	$join_table1 = "play_product_category";
	$on1 = "play_product.category = play_product_category.idx";
	$join_table2 = "play_product_sales";
	$on2 = "play_product.idx = play_product_sales.gidx";
	$and = '';
	if( $_GET ){
		if( $_GET['name']){
